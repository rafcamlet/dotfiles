...
api.nvim_command('au BufEnter * lua require("old_projects").setup()')

api.nvim_command('command! -nargs=1 -complete=customlist,v:lua.open_project_complete OpenProject :lua require("old_projects").open_project(<f-args>)')
