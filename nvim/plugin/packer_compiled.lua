...
_G.packer_plugins = {
  ...
  ["vim-floaterm"] = {
    config = { "\27LJ\2\2Î\1\0\0\2\0\3\0\0056\0\0\0009\0\1\0'\1\2\0B\0\2\1K\0\1\0À\1  let g:floaterm_position = 'center'\n  nnoremap <space>v :FloatermNew --height=1.00 --width=1.00 vifm<cr>\n  nnoremap <space>V :exec 'FloatermNew --height=1.00 --width=1.00  vifm ' .. getcwd()<cr>\n  \bcmd\bvim\0" },
    loaded = true,
    path = "/home/r/.local/share/nvim/site/pack/packer/start/vim-floaterm"
  },
  ["vim-fugitive"] = {
    loaded = true,
...
try_loadstring("\27LJ\2\2Î\1\0\0\2\0\3\0\0056\0\0\0009\0\1\0'\1\2\0B\0\2\1K\0\1\0À\1  let g:floaterm_position = 'center'\n  nnoremap <space>v :FloatermNew --height=1.00 --width=1.00 vifm<cr>\n  nnoremap <space>V :exec 'FloatermNew --height=1.00 --width=1.00  vifm ' .. getcwd()<cr>\n  \bcmd\bvim\0", "config", "vim-floaterm")
